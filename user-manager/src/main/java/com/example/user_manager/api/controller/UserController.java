...
import com.example.user_manager.api.converter.UserModelConverter;
...
public class UserController {
    ...
    @Cacheable(value = "userCache", key = "'users_' + #page + '_' + #size + '_' + #sortBy + '_' + #sortDirection", cacheManager = "cacheManager")
    @GetMapping
