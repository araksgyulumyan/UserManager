...
public interface UserService {
     ...
     * @return User
     * @throws com.example.user_manager.api.exception.UserNotFoundApiException if user not exists
     */
     ...
     * @return User
     * @throws com.example.user_manager.api.exception.UserNotFoundApiException if user is not found
     */
